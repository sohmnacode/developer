export const researchers = [
  ...
  {
    id: 'emily-williams-kelly',
    name: 'Emily Williams Kelly',
    role: 'Psychologist & NDE Researcher',
    institution: 'University of Virginia, Division of Perceptual Studies',
    institutionUrl: 'https://med.virginia.edu/perceptual-studies/publications/academic-publications/',
    years: 'Research career',
    domains: ['nde', 'consciousness', 'mediumship'],
    stance: '',
    headline: 'Studied near-death reports and mediumship, and helped synthesize the evidence on mind–brain relationships.',
    bio: 'Kelly published research on near-death experiences, including reports of meeting deceased people, and examined methods for mediumship research. She also co-authored Irreducible Mind and edited a collection of Ian Stevenson\'s writings. These works examine survival claims; they do not establish survival as a scientific conclusion.',
    keyWork: 'Near-Death Experiences with Reports of Meeting Deceased People (2001); Irreducible Mind (2007)',
    methodology: 'Analysis of experience reports · Research synthesis · Methodological critique',
  ...
  },
  {
    ...
    stance: '',
    headline: 'Studied near-death experiences and their counseling implications, including proposals to test reported out-of-body perception.',
    bio: 'Holden\'s published work addresses how near-death experiences affect people and how clinicians can respond. She proposed a hospital-based design for testing claims of visual perception during reported out-of-body experiences and later studied experiences reported after NDEs.',
  ...
  },
  {
    id: 'david-yaden',
    name: 'David B. Yaden',
    role: 'Psychologist & Psychedelic Researcher',
    institution: 'Johns Hopkins University School of Medicine',
    institutionUrl: 'https://www.hopkinspsychedelic.org/yaden',
    years: 'Current',
    domains: ['psychedelics', 'mystical experience', 'consciousness'],
    stance: '',
    headline: 'Studies how psychedelic and related experiences can produce lasting changes in well-being, alongside their risks and ethical questions.',
    bio: 'Yaden is the Roland Griffiths Professor of Psychedelic Research at Johns Hopkins. His research examines psychedelic and psychedelic-like states, how brief experiences can shape longer-term well-being, and how to measure benefits, risks, and ethical issues.',
    keyWork: 'The Varieties of Spiritual Experience (2022); Johns Hopkins psychedelic studies',
    methodology: 'Clinical studies · Psychological measurement · Ethics research',
    controversy: 'Subjective reports of meaningful experiences do not by themselves establish a metaphysical explanation or prove lasting clinical benefit.',
    links: { website: 'https://www.hopkinspsychedelic.org/yaden', lab: 'https://www.hopkinspsychedelic.org/publications' },
    recentPapers: [
      { title: 'The Varieties of Spiritual Experience: 21st Century Research and Perspectives', year: 2022, journal: 'Oxford University Press', url: 'https://www.hopkinspsychedelic.org/yaden' },
      { title: 'Ethical Issues Regarding Nonsubjective Psychedelics as Standard of Care', year: 2022, journal: 'Cambridge Quarterly of Healthcare Ethics', url: 'https://pubmed.ncbi.nlm.nih.gov/36398520/' },
    ],
  },
  {
    id: 'adrian-owen',
    ...
    institutionUrl: 'https://www.schulich.uwo.ca/neuroscience/people/faculty/alphabetical_listing.html',
    years: 'Current',
    domains: ['consciousness', 'neuroimaging', 'brain injury'],
    stance: '',
    headline: 'Uses brain imaging to detect signs of awareness in some patients who cannot respond behaviorally.',
    bio: 'Owen studies consciousness after severe brain injury using functional MRI, EEG, and cognitive tasks. His work has shown that some unresponsive patients can follow instructions through measurable brain activity. This concerns awareness in living patients and is not evidence of consciousness after death.',
    keyWork: 'Detecting Awareness in the Vegetative State (2008)',
    methodology: 'Functional MRI · EEG · Task-based assessment of covert awareness',
    controversy: 'A positive brain response may reveal covert awareness, but negative tests cannot establish its absence in every patient.',
    links: { website: 'https://www.schulich.uwo.ca/neuroscience/people/faculty/alphabetical_listing.html' },
    recentPapers: [
      { title: 'Detecting Awareness in the Vegetative State', year: 2008, journal: 'Annals of the New York Academy of Sciences', url: 'https://pubmed.ncbi.nlm.nih.gov/18591475/' },
    ],
  },
  {
    id: 'helane-wahbeh',
    ...
    institutionUrl: 'https://noetic.org/profile/helane-wahbeh/',
    years: 'Current',
    domains: ['mediumship', 'consciousness', 'altered states'],
    stance: '',
    headline: 'Directs research on consciousness-related experiences, including channeling, mediumship, and remote viewing.',
    bio: 'Wahbeh is Director of Research at the Institute of Noetic Sciences. Her program examines unusual experiences and extended human capacities using interdisciplinary methods. Her work also spans mind–body medicine and stress physiology.',
    keyWork: 'The Science of Channeling (2021); IONS consciousness research',
    methodology: 'Surveys · Experimental studies · Interdisciplinary research',
    controversy: 'Claims about anomalous information require strong controls, independent replication, and careful separation of experience from interpretation.',
    links: { website: 'https://noetic.org/profile/helane-wahbeh/' },
    recentPapers: [
      { title: 'The Science of Channeling', year: 2021, journal: 'New Harbinger Publications', url: 'https://noetic.org/profile/helane-wahbeh/' },
    ],
  },
  {
    id: 'julie-beischel',
    name: 'Julie Beischel',
    role: 'Mediumship Researcher',
    institution: 'Windbridge Research Center',
    institutionUrl: 'https://www.windbridge.org/about-us/beischel/',
    years: 'Research career',
    domains: ['mediumship', 'after-death communication', 'bereavement'],
    stance: '',
    headline: 'Developed blinded protocols for studying information reported by mediums and examined possible effects on bereavement.',
    bio: 'Beischel co-founded the Windbridge Research Center and is its Director of Research Emerita. Her published studies use blinded reading protocols and examine mediums\' experiences and the possible role of readings in grief. Interpretations of any accurate statements remain debated.',
    keyWork: 'Anomalous Information Reception by Research Mediums under Blinded Conditions II (2015)',
    methodology: 'Blinded reading protocols · Participant comparison · Bereavement research',
    controversy: 'Even under blinding, information leakage, scoring choices, replication, and alternative sources of information remain central questions.',
    links: { website: 'https://www.windbridge.org/about-us/beischel/', archive: 'https://www.windbridge.org/research/completed-studies/' },
    recentPapers: [
      { title: 'Anomalous Information Reception by Research Mediums under Blinded Conditions II: Replication and Extension', year: 2015, journal: 'Explore', url: 'https://doi.org/10.1016/j.explore.2015.01.001' },
    ],
  },
  {
    id: 'jim-tucker',
  ...
  },
  {
    ...
    recentPapers: [
      { title: 'Many Lives, Many Masters', year: 1988, journal: 'Simon & Schuster', url: 'https://www.brianweiss.com/about-the-books/many-lives-many-masters/' },
      { title: 'Miracles Happen: The Transformational Healing Power of Past-Life Memories', year: 2012, journal: 'Hay House', url: 'https://books.google.com/books/about/Miracles_Happen.html?id=nWP6Vz11gcoC' },
    ],
  },
  {
    id: 'dolores-cannon',
    ...
    institution: 'Ozark Mountain Publishing',
    institutionUrl: 'https://ozarkmt.com/',
    years: '1931–2014',
    domains: ['past-life regression', 'reincarnation', 'consciousness'],
    stance: 'Survival',
    headline: 'Developed Quantum Healing Hypnosis Technique (QHHT) and published accounts from hypnosis sessions exploring past lives, between-life experiences, and metaphysical themes.',
    bio: 'Cannon began exploring hypnotic regression with her husband Johnny in 1968 and resumed client sessions in the late 1970s. She later developed QHHT, a method using deep hypnosis and guided questions. Her books interpret clients’ session narratives about past lives, death, spiritual beliefs, and reported extraordinary experiences. She founded Ozark Mountain Publishing in 1992 to publish her work and that of other authors. These accounts document what participants reported under hypnosis; they do not independently establish that the reported events or healing claims occurred.',
    keyWork: 'Between Death and Life (1993); The Custodians (1998); The Convoluted Universe series (2001–); The Three Waves of Volunteers and the New Earth (2011)',
    methodology: 'Hypnotic regression interviews · Recorded session narratives · Historical comparisons described by Cannon · Interpretive book-length case accounts',
    controversy: 'Hypnosis can influence recall and produce confident but inaccurate memories. Cannon’s past-life, extraterrestrial, and healing interpretations have not been established by controlled evidence; they should be distinguished from independently documented spontaneous-memory cases.',
    links: {
      website: 'https://dolorescannon.com/about/',
      method: 'https://dolorescannon.com/about-qhht/',
      bibliography: 'https://dolorescannon.com/books-by-dolores-cannon-in-the-order-they-were-written/',
    },
    recentPapers: [
      { title: 'Dolores’ Career Biography', year: 'Official archive', journal: 'Background', url: 'https://dolorescannon.com/about/' },
      { title: 'What Is Quantum Healing Hypnosis Technique?', year: 'Official archive', journal: 'Method description', url: 'https://dolorescannon.com/about-qhht/' },
      { title: 'Books by Dolores Cannon in the Order They Were Written', year: 2019, journal: 'Complete bibliography', url: 'https://dolorescannon.com/books-by-dolores-cannon-in-the-order-they-were-written/' },
    ],
  },
  {
    id: 'dean-radin',
  ...
  ...[
    ...
    ['ross-dunseath','Ross Dunseath','Assistant Professor of Research','University of Virginia','neuroimaging','https://med.virginia.edu/perceptual-studies/dops-staff/'],
    ['marieta-pehlivanova','Marieta Pehlivanova','Research Assistant Professor','University of Virginia','NDE · after-death communication','https://med.virginia.edu/perceptual-studies/dops-staff/'],
    ['marina-weiler','Marina Weiler','Assistant Professor','University of Virginia','OBE · mediumship · telepathy','https://med.virginia.edu/perceptual-studies/dops-staff/'],
    ['saeedeh-sadeghi','Saeedeh Sadeghi','Postdoctoral Researcher','University of Virginia','past-life memory · altered states','https://med.virginia.edu/perceptual-studies/dops-staff/'],
    ['kim-penberthy','Kim Penberthy','Clinical Psychologist & Researcher','University of Virginia','mindfulness · hospice','https://med.virginia.edu/perceptual-studies/dops-staff/'],
